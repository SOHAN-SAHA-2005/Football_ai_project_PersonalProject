...
class SpeedAndDistanceEstimator:
    def __init__(self):
        ...
        self.frame_rate = 24.0  # Assuming 24 FPS video
    ...
    def add_speed_and_distance_to_tracks(self, tracks):
        ...
        for object, object_tracks in tracks.items():
            if object == 'ball' or object == 'referee':
                continue  # Skip ball and referee for speed estimation
            ...
            for frame_num in range(0, number_of_frames, self.frame_window):
                ...
                for track_id,_ in object_tracks[frame_num].items():
                    if track_id not in object_tracks[last_frame]:
                        continue  # Skip if the track_id is not present in the last frame
                    ...
                    if start_position is None or end_position is None:
                        continue  # Skip if positions are not available
